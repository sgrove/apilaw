  ...
  render() {
    ...
    return (
      <div className="clearfix colelem" style={
        ...
        <div className="browser_width shared_content" id="u232-bw" data-content-guid="u232-bw_content" style={{height: 0}}>
          <div className="shadow" id="u232">{/* simple frame */}</div>
        </div>
        <a
        ...
        <nav className="MenuBar clearfix" id="menuu1997">
          {/* horizontal box */}
          ...
          <div className="MenuItemContainer clearfix grpelem" id="u2105">
            {/* vertical box */}
            <Link
              className={
                'nonblock nontext MenuItem MenuItemWithSubMenu clearfix colelem' +
