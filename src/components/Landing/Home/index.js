    ...
    return (
      <div id="home">
        ...
        <div
          ...
          data-max-width={1200}>
          {/* responsive breakpoint node */}
          <div className="clearfix temp_no_id" data-orig-id="page">
            {/* column */}
            <div
              ...
              <div className="clearfix colelem temp_no_id" data-orig-id="pu94">
                ...
                <nav
                  className="MenuBar clearfix temp_no_id"
                  data-orig-id="menuu1997">
                  {/* horizontal box */}
                  <div
                    className="MenuItemContainer clearfix grpelem temp_no_id"
                    data-orig-id="u1998">
                    {/* vertical box */}
                    <a
                      className="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive clearfix colelem temp_no_id"
                      href="index.html"
                      data-orig-id="u1999">
                      {/* horizontal box */}
                      <div
                        className="MenuItemLabel NoWrap clearfix grpelem temp_no_id"
                        data-orig-id="u2001-4">
                        {/* content */}
                        <span
                          className="placeholder"
                          data-placeholder-for="u2001-4_0_content">
                          {/* placeholder node */}
                        </span>
                      </div>
                    </a>
                  ...
                  <div
                    ...
                    {/* vertical box */}
                    <a
                      className="nonblock nontext MenuItem MenuItemWithSubMenu transition clearfix colelem temp_no_id"
                      href="practice.html"
                      data-orig-id="u2045">
                      {/* horizontal box */}
                      <div
                        className="MenuItemLabel NoWrap clearfix grpelem temp_no_id"
                        data-orig-id="u2046-4">
                        {/* content */}
                        <span
                          className="placeholder"
                          data-placeholder-for="u2046-4_0_content">
                          {/* placeholder node */}
                        </span>
                      </div>
                    </a>
                  ...
                  <div
                    ...
                    <a
                      ...
                      <div
                        className="MenuItemLabel NoWrap clearfix grpelem temp_no_id"
                        data-orig-id="u2068-4">
                        {/* content */}
                        <span
                          className="placeholder"
                          data-placeholder-for="u2068-4_0_content">
                          {/* placeholder node */}
                        </span>
                      </div>
                    </a>
                  ...
                  <div
                    ...
                    <a
                      ...
                      <div
                        className="MenuItemLabel NoWrap clearfix grpelem temp_no_id"
                        data-orig-id="u2111-4">
                        {/* content */}
                        <span
                          className="placeholder"
                          data-placeholder-for="u2111-4_0_content">
                          {/* placeholder node */}
                        </span>
                      </div>
                    </a>
                ...
                <span
                  className="shadow clearfix placeholder"
                  data-placeholder-for="u2126-4_content">
                  {/* placeholder node */}
                </span>
              </div>
              <span
              ...
              <span
                ...
                data-placeholder-for="u124-4_content">
                {/* placeholder node */}
              </span>
              <span
                className="clearfix colelem placeholder"
              ...
              <span
                className="clearfix colelem placeholder"
                data-placeholder-for="pu447_content">
                {/* placeholder node */}
              </span>
              <span
                className="browser_width colelem placeholder"
                data-placeholder-for="u2171-bw_content">
                {/* placeholder node */}
              </span>
              <div className="clearfix colelem temp_no_id" data-orig-id="pu733">
                ...
                <form
                  ...
                  <input
                    className="submit-btn NoWrap grpelem temp_no_id"
                    type="submit"
                    value=""
                    tabIndex={13}
                    data-orig-id="u753-17"
                  />
                  {/* state-based BG images */}
                  <div
                    className="fld-grp clearfix grpelem temp_no_id"
              ...
              <span
                className="browser_width colelem placeholder"
                data-placeholder-for="u860-bw_content">
                {/* placeholder node */}
              </span>
              <div
                ...
                <span
                  className="browser_width grpelem placeholder"
                  data-placeholder-for="u1088-bw_content">
                  {/* placeholder node */}
                </span>
                <span
                  className="browser_width grpelem placeholder"
                ...
                <span
                  className="browser_width grpelem placeholder"
                  data-placeholder-for="u1213-bw_content">
                  {/* placeholder node */}
                </span>
                <span
                  className="browser_width grpelem placeholder"
              ...
              <div
                ...
                <span
                  className="browser_width grpelem placeholder"
                  data-placeholder-for="u1467-bw_content">
                  {/* placeholder node */}
                </span>
                <div
                  ...
                  <div
                    ...
                    <div
                      ...
                      <div
                        ...
                        {/* group */}
                        <span
                          className="clearfix grpelem placeholder"
                          data-placeholder-for="u1686_content">
                          {/* placeholder node */}
                        </span>
                      </div>
                      <div
                        ...
                        <span
                          className="clearfix grpelem placeholder"
                          data-placeholder-for="u1683_content">
                          {/* placeholder node */}
                        </span>
                      </div>
                    </div>
              ...
              <div
                ...
                <div className="temp_no_id" data-orig-id="u1625">
                  ...
                  <div
                    ...
                    <span
                      className="clearfix colelem placeholder"
                      data-placeholder-for="u1680_content">
                      {/* placeholder node */}
                    </span>
                  </div>
                </div>
              ...
              <span
                className="colelem placeholder"
                data-placeholder-for="u2152_content">
                {/* placeholder node */}
              </span>
              <div
                className="verticalspacer"
                data-offset-top={5878}
                data-content-above-spacer={5877}
                data-content-below-spacer={91}
              />
              <span
                className="clearfix colelem placeholder"
                data-placeholder-for="pu1110_content">
                {/* placeholder node */}
              </span>
            </div>
          </div>
          <div className="preload_images">
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-r2.png?crc=4217847756"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-m2.png?crc=4217847756"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-fs2.png?crc=3941467825"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-r2.png?crc=3842467463"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-m2.png?crc=3842467463"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-fs2.png?crc=509054720"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
        ...
        <div
          ...
          <div className="clearfix temp_no_id" data-orig-id="page">
            ...
            <div
              ...
              <div
                ...
                <div className="temp_no_id" data-orig-id="u860">
                  ...
                  <div
                    ...
                    <span
                      className="clearfix colelem placeholder"
                      data-placeholder-for="pu866-4_content">
                      {/* placeholder node */}
                    </span>
                    <div
                      className="clearfix colelem temp_no_id"
                      ...
                      <span
                        className="clearfix grpelem placeholder"
                        data-placeholder-for="pu967-12_content">
                        {/* placeholder node */}
                      </span>
                    </div>
                  </div>
                    ...
                    <div
                      ...
                      <div
                        ...
                        <div
                          ...
                          data-orig-id="u1686">
                          {/* group */}
                          <div className="clearfix grpelem" id="pu1695">
                            {/* column */}
                            <span
                              className="clearfix colelem placeholder"
                      ...
                      <div
                        ...
                        <div
                          ...
                          data-orig-id="u1683">
                          {/* group */}
                          <div className="clearfix grpelem" id="pu1554">
                            {/* column */}
                            <span
                              className="clearfix colelem placeholder"
              ...
              <div
                className="verticalspacer"
                data-offset-top={6899}
                data-content-above-spacer={6899}
          ...
          <div className="preload_images">
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-r3.png?crc=171551299"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-m3.png?crc=171551299"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-fs3.png?crc=4289920847"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-r3.png?crc=3842467463"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-m3.png?crc=3842467463"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-fs3.png?crc=509054720"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
        ...
        <div
          ...
          <div className="clearfix temp_no_id" data-orig-id="page">
            ...
            <div
                ...
                <div
                  ...
                  <div
                    ...
                    <div
                      ...
                      <div className="clearfix grpelem" id="pu372">
                        {/* column */}
                        <span
                          className="clearfix colelem placeholder"
                      ...
                      <div className="clearfix grpelem" id="pu618">
                        {/* column */}
                        <span
                          className="clearfix colelem placeholder"
                  ...
                  <div
                    ...
                    <div
                      ...
                      <div
                        ...
                        {/* group */}
                        <span
                          className="transition shadow clearfix grpelem placeholder"
                          data-placeholder-for="u875-12_content">
                          {/* placeholder node */}
                        </span>
                        <span
                      ...
                      <div className="clearfix colelem" id="pu1001-12">
                        {/* group */}
                        <span
                          className="transition shadow clearfix grpelem placeholder"
                          data-placeholder-for="u1001-12_content">
                ...
                <div
                  ...
                  <div className="temp_no_id" data-orig-id="u1088">
                    ...
                    <div
                      ...
                      <span
                        className="clearfix colelem placeholder"
                        data-placeholder-for="pu1113-4_content">
                        {/* placeholder node */}
                      </span>
                      <span
                      ...
                      <div className="clearfix colelem" id="pu1130-21">
                        {/* group */}
                        <span
                ...
                <div
                  ...
                  <div className="museBGSize temp_no_id" data-orig-id="u1213">
                    ...
                    <div
                      ...
                      <div className="clearfix grpelem" id="pu1139-6">
                        {/* column */}
                        <span
                      ...
                      <div className="clearfix grpelem" id="pu1145-6">
                        {/* column */}
                        <span
              ...
              <div
                ...
                <div className="temp_no_id" data-orig-id="u1625">
                  ...
                  <div
                    className="clearfix temp_no_id"
                    data-orig-id="u1625_align_to_page">
                    <div className="clearfix colelem" id="pu1838-9">
                      {/* group */}
                      <span
                        className="ourclients clearfix grpelem placeholder"
                        data-placeholder-for="u1838-9_content">
                        {/* placeholder node */}
                      </span>
                      <span
              ...
              <div
                className="verticalspacer"
                data-offset-top={8882}
                data-content-above-spacer={8882}
                data-content-below-spacer={399}
              />
              <div
                className="clearfix colelem temp_no_id"
                data-orig-id="pu1110">
                ...
                <div
                  ...
                  <div className="temp_no_id" data-orig-id="u1110">
                    ...
                    <div
                      ...
                      <div className="clearfix colelem" id="ppu2270-6">
                        {/* group */}
                        <span
                          className="clearfix grpelem placeholder"
                          data-placeholder-for="pu2270-6_content">
                          {/* placeholder node */}
                        </span>
                        <span
                          className="clearfix grpelem placeholder"
          ...
          <div className="preload_images">
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-r4.png?crc=122963081"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-m4.png?crc=122963081"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-fs4.png?crc=193939537"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-r4.png?crc=3842467463"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-m4.png?crc=3842467463"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-fs4.png?crc=509054720"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
        ...
        <div
          ...
          <div className="clearfix temp_no_id" data-orig-id="page">
            ...
            <div
                  ...
                  <div className="popup_anchor" id="u35016popup">
                    <div className="ContainerGroup clearfix" id="u35016">
                      ...
                      <div
                        ...
                        {/* column */}
                        <nav
                          className="MenuBar clearfix colelem"
                          id="menuu35019">
                          {/* vertical box */}
                          <div
                            ...
                            {/* horizontal box */}
                            <a
                              className="nonblock nontext MenuItem MenuItemWithSubMenu MuseMenuActive clearfix grpelem"
                              id="u35037"
                              href="index.html">
                              {/* horizontal box */}
                              <div
                          ...
                          <div
                            ...
                            {/* horizontal box */}
                            <a
                              className="nonblock nontext MenuItem MenuItemWithSubMenu transition clearfix grpelem"
                              id="u35023"
                              href="practice.html">
                              {/* horizontal box */}
                              <div
                        ...
                        <a
                          ...
                          {/* content */}
                          <p id="u35018-2">Call Us : +394847 848 8485</p>
                        </a>
                      </div>
                    </div>
                  </div>
                  <div className="ThumbGroup clearfix grpelem" id="u35011">
                    {/* none box */}
                    <div className="popup_anchor">
                      <div className="Thumb popup_element clearfix" id="u35012">
                        {/* group */}
                        <div
                          className="grpelem shared_content"
                          id="u35013"
                          data-content-guid="u35013_content">
                          {/* custom html */}
              ...
              <div
                className="headtitle clearfix colelem shared_content"
                id="u35667-4"
                data-content-guid="u35667-4_content">
                {/* content */}
              ...
              <div
                ...
                <div className="temp_no_id" data-orig-id="u2171">
                  ...
                  <div
                    ...
                    <span
                      className="clearfix colelem placeholder"
                      data-placeholder-for="pu709-4_content">
                      {/* placeholder node */}
                    </span>
                    <span
                    ...
                    <div
                      ...
                      <div
                        ...
                        <div
                          ...
                          <div
                            className="position_content temp_no_id"
                            data-orig-id="u1686_position_content">
                            <span
                              className="clearfix colelem placeholder"
                              data-placeholder-for="u1695_content">
                              {/* placeholder node */}
                      ...
                      <div
                        ...
                        <div
                          ...
                          <div
                            className="position_content temp_no_id"
                            data-orig-id="u1683_position_content">
                            <span
                              className="clearfix colelem placeholder"
                              data-placeholder-for="u1554_content">
                              {/* placeholder node */}
              ...
              <div
                ...
                data-offset-top={9334}
                data-content-above-spacer={9334}
                data-content-below-spacer={398}
                data-content-guid="page_position_content_14_content"
              />
              <div
                className="clearfix colelem temp_no_id"
                data-orig-id="pu1110">
          ...
          <div className="preload_images">
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-r5.png?crc=122963081"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-m5.png?crc=122963081"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-fs5.png?crc=193939537"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-r5.png?crc=3842467463"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-m5.png?crc=3842467463"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-fs5.png?crc=509054720"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
        ...
        <div
          ...
          <div className="clearfix borderbox temp_no_id" data-orig-id="page">
            ...
            <div
                ...
                <div
                  ...
                  <div className="museBGSize temp_no_id" data-orig-id="u1213">
                    ...
                    <div
                      ...
                      <div
                        className="position_content"
                        id="u1213_position_content">
                        <div
                          className="clearfix colelem temp_no_id"
                          data-orig-id="pu1139-6">
                          {/* group */}
                          <span
                            className="rgba-background chart1 transition clearfix grpelem placeholder"
                            data-placeholder-for="u1139-6_content">
                            {/* placeholder node */}
                          </span>
                          <span
                            className="rgba-background chart2 transition clearfix grpelem placeholder"
                            data-placeholder-for="u1145-6_content">
                            {/* placeholder node */}
                          </span>
                        </div>
                        <div className="clearfix colelem" id="pu1142-6">
                          {/* group */}
                          <span
                            className="rgba-background chart3 transition clearfix grpelem placeholder"
                            data-placeholder-for="u1142-6_content">
                            {/* placeholder node */}
                          </span>
                          <span
                            className="rgba-background chart4 transition clearfix grpelem placeholder"
                            data-placeholder-for="u1148-6_content">
                            {/* placeholder node */}
                          </span>
                        </div>
              ...
              <span
                className="verticalspacer placeholder"
                data-placeholder-for="page_position_content_14_content">
                {/* placeholder node */}
              </span>
              <div
                className="clearfix colelem temp_no_id"
          ...
          <div className="preload_images">
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-r6.png?crc=122963081"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-m6.png?crc=122963081"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-fs6.png?crc=193939537"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-r6.png?crc=3842467463"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-m6.png?crc=3842467463"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-fs6.png?crc=509054720"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
        ...
        <div
          ...
          <div className="clearfix borderbox temp_no_id" data-orig-id="page">
            ...
            <div
              ...
              <div className="clearfix colelem" id="pu1210">
                {/* group */}
                <span
                  className="browser_width grpelem placeholder"
                  data-placeholder-for="u1210-bw_content">
              ...
              <div className="clearfix colelem" id="pppu1467">
                {/* group */}
                <div className="clearfix grpelem" id="ppu1467">
                  {/* column */}
                  <div
                    className="clearfix colelem temp_no_id"
                    data-orig-id="pu1467">
                    ...
                    <div className="temp_no_id" data-orig-id="u1625">
                      ...
                      <div
                        ...
                        <div
                          ...
                          data-orig-id="u1680">
                          {/* group */}
                          <div className="clearfix grpelem" id="pu1628">
                            {/* column */}
                            <span
                          ...
                          <div className="clearfix grpelem" id="pu1659">
                            {/* column */}
                            <span
                              className="museBGSize colelem placeholder"
                          ...
                          <div className="clearfix grpelem" id="pu1668">
                            {/* column */}
                            <span
                              className="museBGSize colelem placeholder"
              ...
              <div
                className="verticalspacer"
                data-offset-top={11028}
                data-content-above-spacer={11027}
                data-content-below-spacer={671}
              />
              <div
                className="clearfix colelem temp_no_id"
                data-orig-id="pu1110">
          ...
          <div className="preload_images">
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-r7.png?crc=122963081"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-m7.png?crc=122963081"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u753-17-fs7.png?crc=193939537"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-r7.png?crc=3842467463"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-m7.png?crc=3842467463"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
              className="preload temp_no_img_src"
              data-orig-src="images/u1270-17-fs7.png?crc=509054720"
              alt
              src="images/blank.gif?crc=4208392903"
            />
            <img
        ...
        <div className="breakpoint" id="bp_400" data-max-width={400}>
          ...
          <div className="clearfix borderbox temp_no_id" data-orig-id="page">
            ...
            <div
              ...
              <div
                className="verticalspacer"
                data-offset-top={11773}
                data-content-above-spacer={11773}
                data-content-below-spacer={670}
              />
              <div
                className="clearfix colelem temp_no_id"
                data-orig-id="pu1110">
